<?php
$id = var_get('id');
$ParentElement = new Locations();
$ParentElement->GetByID($id);
if (!$ParentElement->Selected) {
	die;
}

echo '<form method="post" action="'.$PAGE_LINK.'&a=701&id='.$ParentElement->id.'">'.
'<p>'.i_EnterLocationElementData.':</p>
<table class="NoBorderTable" width="100%">';

$formInfo = sprintf (i_CreatingChildLocationElemFrom, $ParentElement->id, $ParentElement->Title);
echo '<tr>
...
echo '<tr>
	<td width="100%" align="center" colspan="2">
	<label for="Title">'.i_LocationElementTitle.':</label><input type="text" name="Title" id="Title" cols="80" length="255"></td>
</tr>
<tr>
	<td width="100%" align="center" colspan="2">
